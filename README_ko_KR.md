...
Chyrp Lite를 사용하면 자신의 웹 서버에서 최소한의 노력으로 블로그를 호스팅할 수 있습니다.
전통적인 블로그, 텀블 블로그를 가질 수도 있고, 다양한 사용자 정의를 추가하고 측면에 블로깅 기능이
있는 범용 웹 게시 플랫폼을 구축할 수도 있습니다. 기본으로 제공하는 블로그 테마와 관리 콘솔을
사용할 수 있으며 반응이 빠른 HTML5로 다양한 장치에서 완벽하게 탐색할 수 있습니다.
...
있으며 BSD 라이선스 에 따라 배포됩니다 . Chyrp Lite와 함께 배포되는 모든 소프트웨어 패키지의
